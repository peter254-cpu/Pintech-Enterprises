...
const GiftCoupon = () => {
    const [userInputCode, setUserInputCode] = useState(" ")
     const { coupon, couponIsApplied, applyCoupon, removeCoupon, getMyCoupon} = useCartStore()
  ...
  return (
    ...
    >
        <div className="space-y-4">
            <div>
                <label htmlFor="voacher" className="mb-2 block text-sm font-medium text-gray-300">
