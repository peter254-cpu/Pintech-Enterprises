...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-gray-900 backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b border-emerald-800">
      <div className="container mx-auto px-4 py-3 flex justify-between flex-wrap items-center">
        <Link
          path="/"
          className="text-2xl font-bold text-emerald-400 hover:text-emerald-800 transition duration-300 ease-in-out"
        >
          Pintech
        </Link>
